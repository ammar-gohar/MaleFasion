...
if(isset($_SESSION["signin_errors"])){
  ...
  unset($_SESSION["singup_errors"]);
};

if(isset($_SESSION["old_signin_inputs"])){
  $old = $_SESSION["old_signin_inputs"];
  unset($_SESSION["old_signin_inputs"]);
};
        ...
        <div class="row">
          <div class="col-12">
            <div class="mb-5">
              ...
              <p class="text-center m-0">Already have an account? <a href="./signup.php" class="link-primary text-decoration-none">Sign up</a></p>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 col-lg-10 col-xl-8">
            <div class="row gy-5 justify-content-center">
              <div class="col-12 col-lg-5">
                <form action="<?= _ROOT_ . '/routes/signin.php' ?>" method="post">
                  <div class="row gy-3 overflow-hidden">
                    <div class="col-12">
                      <div class="form-floating mb-3">
                        <input type="text" class="form-control border-0 border-bottom rounded-0" name="input" id="input" placeholder="input:" value="<?= isset($old) ? $old["input"] : '' ?>" required>
                    ...
                    <div class="col-12">
                      <div class="d-grid">
                        <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Sign in</button>
                      </div>
                    </div>
                  </div>
                </form>
